  ...
  <section id="about">
    <div class="row">
      ...
      <div class="col-7">
        ...
        <p>Oh yeah, I'm also a final semester student at <a href="https://www.ars.ac.id" target="_blank" rel="noopener noreferrer">ARS University</a></p>
        <p>Here are a few technologies I’ve been working with recently:</p>
        <div class="row">
          <div class="col-6">
            <li class="text-success">PHP</li>
            <li class="text-success">Node JS</li>
            <li class="text-success">Python</li>
          </div>

          <div class="col-6">
            <li class="text-success">Laravel</li>
            <li class="text-success">Expressjs</li>
            <li class="text-success">FastAPI</li>
          </div>
        </div>
      </div>
      <div class="col-5">
